...
public class DCommand extends CommandBase {
     ...
     */
    public DCommand setPermissionLevel(int permissionLevel) {
        this.permissionLevel = permissionLevel;
        return this;
    }

    /**
     * Add a new alias to this command.
     *
     * @param name the new alias
     * @return this command instance
     */
    public DCommand addAlias(String name) {
        aliases.add(name);
        return this;
    }
     ...
     * @return this command instance
     */
    public <T> DCommand addRequiredArgument(String argument, Class<T> type) {
        if (!this.optionalArguments.isEmpty()) {
            DebugTools.LOGGER.error("Please register required arguments before optional ones! Skipping argument {} with type {}.", argument, type);
            return this;
        }
        ...
        if (argumentParser != null) {
            ...
            DebugTools.LOGGER.error("Unable to find argument parser for type {}. Skipping argument.", type);
        }
        return this;
    }
     ...
     * @return this command instance
     */
    public <T> DCommand addOptionalArgument(String argument, Class<T> type) {
        IArgumentParser<T> argumentParser = CommandHandler.INSTANCE.getParserForType(type);
        if (argumentParser != null) {
